...
########################PREDICTION_DEMANDE_ENPRUNT_CLIENT########################
@app.post("/predict") 
async def predict_decision(pred_id : Predict_id):
    ...
    # calcul la probabilité de remboursement du credit
...
########################CHARGEMENT_DU_FICHIER_SUR_UN_PETIT_JEU_DE_DONNEE########################
def load_df_kernel():
